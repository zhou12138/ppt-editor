...
python pptx_editor_com.py test_report.pptx "put title as Demo Test OK" --output test_out_title.pptx
echo.

echo === Step 4: Font size ===
python pptx_editor_com.py test_report.pptx "slide 1 title font size 40" --output test_out_fontsize.pptx
echo.

echo === Step 5: Bold ===
python pptx_editor_com.py test_report.pptx "slide 1 title bold" --output test_out_bold.pptx
echo.

echo === Step 6: Color red ===
python pptx_editor_com.py test_report.pptx "slide 1 title color red" --output test_out_color.pptx
echo.
...
python pptx_editor_com.py test_report.pptx "delete table on slide 2" --output test_out_delete.pptx
echo.
